...
Процедура ЗагрузитьИзФайла(ИмяФайла) Экспорт
	...
	Если V8Exchan.ФлагОшибки Тогда
		ВызватьИсключение "Ошибка при загрузке данных";
	КонецЕсли;
...
Процедура ИнициализироватьV8Exchan()
	Если V8Exchan = Неопределено Тогда
		...
		ПапкаФайловПлагина = "c:\Program Files (x86)\OneScript\lib\add\plugins\КонвертацияДанных2\";

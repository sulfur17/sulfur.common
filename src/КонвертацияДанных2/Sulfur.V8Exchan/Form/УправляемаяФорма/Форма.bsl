...
Процедура ПриСохраненииДанныхВНастройкахНаСервере(Настройки)
	...
	Настройки.Вставить("ОтборыПоДоговорам", ОтборыПоДоговорам());
...
Процедура ПередЗагрузкойДанныхИзНастроекНаСервере(Настройки)
	...
	ОтборыПоДоговорам = Настройки["ОтборыПоДоговорам"];
	
	Если ОтборыПоДоговорам = Неопределено Тогда
		Возврат;
	КонецЕсли;
	...
	СтрокаПравилВыгрузки = Объект.ТаблицаПравилВыгрузки.НайтиПоИдентификатору(СтрокаПравилВыгрузкиДоговоров);
	
	СтрокаПравилВыгрузки.ИспользоватьОтбор = ЗначениеЗаполнено(ОтборыПоДоговорам);
	
	Для Каждого ЭлементОтборов Из ОтборыПоДоговорам Цикл
		
		ЭлементПостроителя = СтрокаПравилВыгрузки.НастройкиПостроителя.Элементы.Добавить(Тип("ЭлементОтбораКомпоновкиДанных"));
		
		ЭлементПостроителя.ЛевоеЗначение = Новый ПолеКомпоновкиДанных("Ссылка");
		
		Если ТипЗнч(ЭлементОтборов) = Тип("СписокЗначений") Тогда
		...
		ЭлементПостроителя.ПравоеЗначение = ЭлементОтборов;

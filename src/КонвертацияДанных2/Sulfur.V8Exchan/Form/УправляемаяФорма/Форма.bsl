...
&НаКлиенте
Процедура НачатьПомещениеФайлаСДиалогом(ОписаниеОповещения, АдресФайла, ЗаголовокДиалога, НенужныйПараметр = Неопределено, УникальныйИдентификатор)
	...
	НачатьПомещениеФайлаНаСервер(ОписаниеПродолжения, , , АдресФайла, ПараметрыДиалогаПомещенияФайлов, УникальныйИдентификатор);

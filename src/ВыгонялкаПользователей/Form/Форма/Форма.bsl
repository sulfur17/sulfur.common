...
Процедура ВыгнатьНаСервере()
	...
	Блокировка.Начало = ДобавитьМинуту(ТекущаяДатаСеанса(), ЧерезСколькоМинутВыгнать);
	Блокировка.Конец = ДобавитьМинуту(Блокировка.Начало, НаСколькоМинутЗапретитьВход);
...
Функция ДобавитьМинуту(Дата, КоличествоМинут)
